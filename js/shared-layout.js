(function () {
  ...
  const footer = `<footer class="site-footer" aria-label="Footer"><div class="site-footer__inner">
    ...
    <div class="footer-col footer-col--info"><ul class="footer-info-list"><li><span aria-hidden="true">✉</span><a href="mailto:Vincidigital2026@outlook.com">Vincidigital2026@outlook.com</a></li><li><span aria-hidden="true">◎</span><a href="https://www.vincidigital.online">www.vincidigital.online</a></li><li><span aria-hidden="true">⌖</span><span>Potchefstroom, South Africa</span></li></ul></div>
